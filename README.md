# Домашнее задание к занятию 5. «Практическое применение Docker» Сафронов П.А.
...
3. Опишите в файле [compose.yaml](https://github.com/Briefklammern/shvirtd-example-python/blob/main/compose.yaml) следующие сервисы: 
...
Скачать файл используя слои у меня не вышло, ввиду почему-то различающихся имен слоев в ```Dive``` и в распакованном архиве. На скрине работы ```dive``` слой начинается с ```dd577cc...```, в распакованных файлах такого нет: 

![BLOBS](./img/11.PNG)

Дернул файл по другому.
